                ...
                {userData.role?.find((roles) => "RLADM".includes(roles)) ? (
                  ...
                  <div className="col-12">
                    ...
                    {userData.role?.find((roles) => "RLMHS".includes(roles)) &&
                      ...
                      sidang.status === "lulus" && (
                        <div className="alert alert-success" role="alert">
                          Selamat Anda Dinyatakan <b>LULUS</b> pada sidang
                          periode {sidang.period_id}
                        </div>
                      )}
                    <hr className="mt-0" />
                    <h6 className="mb-3">
                    ...
                    <div className="card">
                      <div className="card-body">
                        <p>
                          Jika sudah mendapatkan jadwal sidang Mohon konfirmasi
                          ke dosen pembimbing dan penguji
                        </p>
                      </div>
                    </div>
                    <div className="card">
                      <div className="card-body">
                        ...
                        <ol>
                          ...
                          <li>
                            ...
                            ditentukan 15 menit sebelum pelaksanaan sidang,
                            untuk melakukan persiapan
                          </li>
                          <li>
                            Peserta sidang dilarang mengambil gambar
                            (Foto/Video) selama sidang berlangsung
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            jurnal, materi presentasi dan proses sidang tugas
